...
downloaded_data_path = f"dtd/images"
output_path = f"dtd"
...
process_dataset(
    f'dtd/labels/train.txt', downloaded_data_path, os.path.join(output_path, "train")
)
process_dataset(
    f'dtd/labels/test.txt', downloaded_data_path, os.path.join(output_path, "val")
)